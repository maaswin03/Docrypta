        ...
        <SidebarInset className="flex flex-col h-screen overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto min-h-0">
            <div className="p-4 space-y-6 max-w-full">
              {/* Placeholder content with fixed heights */}
              <div className="grid gap-6 grid-cols-1 md:grid-cols-3">
                <div className="h-[200px] rounded-xl bg-muted/50 flex items-center justify-center">
                  <span className="text-muted-foreground">Chart 1</span>
                </div>
                <div className="h-[200px] rounded-xl bg-muted/50 flex items-center justify-center">
                  <span className="text-muted-foreground">Chart 2</span>
                </div>
                <div className="h-[200px] rounded-xl bg-muted/50 flex items-center justify-center">
                  <span className="text-muted-foreground">Chart 3</span>
                </div>
              </div>
