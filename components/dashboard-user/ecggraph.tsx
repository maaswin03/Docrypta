  ...
  return (
    <Card className="w-full h-full flex flex-col overflow-hidden">
      <CardHeader className="flex flex-col items-stretch border-b !p-0 sm:flex-row flex-shrink-0">
        <div className="flex flex-1 flex-col justify-center gap-1 px-4 py-3 sm:px-6 sm:py-4">
          ...
          {["ecg", "filtered"].map((key) => {
            ...
            return (
              ...
              >
                ...
                <span className="text-sm leading-none font-bold">View</span>
              </button>
            )
          })}
        </div>
      ...
      <CardContent className="px-3 py-3 sm:p-4 flex-1 min-h-0 overflow-hidden">
        {error ? (
          ...
          <ChartContainer config={chartConfig} className="h-full w-full">
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                />
                <YAxis tickLine={false} axisLine={false} tickMargin={6} tick={{ fontSize: 10 }} />
